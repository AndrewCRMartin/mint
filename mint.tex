...
2. Source the Modeller setup script,\\
3. Create an alias to run the MINT program.

Assuming that Modeller has been installed in a directory which is called 
\verb1/usr/user/modeller1 
and MINT in \verb1/home/bsm/martin/modeller1,
the following script will set everything as required:

\begin{verbatim}
setenv MODINSTALL /usr/user/modeller        ! Top of Modeller tree
setenv MINTDIR    /home/bsm/martin/modeller ! The MINT directory

source $MODINSTALL/bin/setmodeller
